...
#### i. The user chooses which calculation they want to do. 
...
#### ii. If the user selects 'investment', the user must input:
...
#### iii. If the user selects ‘bond’, the user must input:
